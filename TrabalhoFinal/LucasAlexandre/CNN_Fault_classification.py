...
plt.legend()
plt.tight_layout()
plt.savefig('CNN_training_curves.png', dpi=200)
plt.show()
...
plt.ylim(82, 100.2)   # mesmo estilo do seu gráfico de referência
plt.grid(axis='y', linestyle='--', alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig("CNN_metrics_per_class.png", dpi=200)
plt.show()
...
print(df_metrics)
df_metrics.to_csv("CNN_metrics_per_class.csv", index=False)
...
plt.savefig("CNN_metrics_table_aligned.png", dpi=200)
plt.show()
