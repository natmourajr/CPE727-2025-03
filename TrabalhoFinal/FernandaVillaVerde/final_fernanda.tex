...
\begin{frame}{Definição do problema}
  ...
  \begin{itemize}
    ...
    \item Estados discretos:
      \(s_t \in \{0,1,4\}\) (após fusão dos 6 estados iniciais).
    ...
    \item Para cada janela de histórico
      ...
      \]
    \item Na prática, o modelo produz, para cada estado \(s \in \{0,1,4\}\),
...
\centering
\includegraphics[width=0.85\linewidth]{/home/ferna/CPE727-2025-03/TrabalhoFinal/FernandaVillaVerde/pdfs.png}
