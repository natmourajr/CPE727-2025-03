...
Este diretório contém o script principal para executar o pipeline completo de treinamento e avaliação para a arquitetura **DBN** no dataset de Tuberculose.
...
```Bash
python src/experiments/CIC_MalMem_2022_DBN/run_experiment.py
```
...
`results/CIC_MALMEM_2022_DBN/[YYYYMMDD_HHMMSS]/`
