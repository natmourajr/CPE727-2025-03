...
Este diretório contém o script principal para executar o pipeline completo de treinamento e avaliação para a arquitetura **CNN** no dataset de Tuberculose.
...
```Bash
python src/experiments/CIC_MalMem_2022_CNN/run_experiment.py
```
...
`results/CIC_MALMEM_2022_CNN_Image_8x8/[YYYYMMDD_HHMMSS]/`
