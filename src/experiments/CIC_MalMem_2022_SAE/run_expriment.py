...
from models.DeepNN_SAE_CIC_MalMem.deepnn_sae_classifier import DeepNN_SAE_Classifier 
from src.dataloaders.CIC_MalMem.tabular_loader import MalMemTabularDataset
from experiments.CIC_MalMem_2022_SAE.run_sae_pretrain import run_ae_pretrain # Importa a função de pré-treino
...
def main():
    ...
    # --- SETUP DO EXPERIMENTO SUPERVISIONADO (JOB 2) ---
    timestamp = Path(pretrain_weights_path).parent.parent.name # Usa o timestamp do pré-treino para agrupar
