...
Este diretório contém o script principal para executar o pipeline completo de treinamento e avaliação para a arquitetura **DeepNN** no dataset de Tuberculose.
...
```Bash
python src/experiments/CIC_MalMem_2022_DeepNN/run_experiment.py
```
...
`results/CIC_MALMEM_2022_DeepNN/[YYYYMMDD_HHMMSS]/`
