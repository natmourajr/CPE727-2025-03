...
class Autoencoder(nn.Module):
    ...
    def __init__(self, input_shape, num_classes, config):
        ...
        # --- ENCODER (16 -> 64) ---
        self.enc1 = nn.Linear(self.input_size, 128)
        self.enc2 = nn.Linear(128, 64)
        self.enc_code = nn.Linear(64, 64) # Camada Latente (Code)
        
        # --- DECODER (64 -> 16) ---
        # Note que o Decoder é simétrico ao Encoder
        self.dec3 = nn.Linear(64, 64)
        self.dec4 = nn.Linear(64, 128)
        self.dec_out = nn.Linear(128, self.input_size) # Saída deve ser do mesmo tamanho da entrada (16)
