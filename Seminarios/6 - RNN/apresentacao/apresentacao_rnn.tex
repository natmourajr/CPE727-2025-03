...
\midrule
\textbf{BiGRU coupled}           & 0.5610 & {$\pm\,0.3509$} \\
BiGRU                      & 0.5684 & {$\pm\,0.3483$} \\
GRU                                & 0.5921 & {$\pm\,0.3298$} \\
BiGRU  gate                 & 0.6054 & {$\pm\,0.3852$} \\
BiLSTM                      & 0.6613 & {$\pm\,0.3705$} \\
BiLSTM coupled                            & 0.6639 & {$\pm\,0.4266$} \\
BiLSTM  gate                & 0.6699 & {$\pm\,0.3597$} \\
LSTM                               & 0.6795 & {$\pm\,0.3659$} \\
BiGRU  GRU Fuser            & 0.6869 & {$\pm\,0.3208$} \\
BiLSTM  GRU Fuser           & 0.7416 & {$\pm\,0.3806$} \\
\bottomrule
\end{tabular}
}% <-- fecha o \resizebox
\end{column}
...
\textbf{Configuração} & \textbf{Média} & \textbf{Desvio padrão} \\
\midrule
\textbf{BiGRU coupled GRU Fuser}           & 0.1234 & {$\pm\,0.0409$} \\
BiLSTM coupled gate                        & 0.1333 & {$\pm\,0.0359$} \\
BiGRU coupled                             & 0.1339 & {$\pm\,0.0355$} \\
BiLSTM coupled                            & 0.1373 & {$\pm\,0.0401$} \\
BiLSTM GRU Fuser           & 0.1390 & {$\pm\,0.0433$} \\
BiGRU gate                 & 0.1406 & {$\pm\,0.0379$} \\
BiGRU                     & 0.1414 & {$\pm\,0.0384$} \\
BiLSTM gate                & 0.1434 & {$\pm\,0.0425$} \\
BiLSTM                     & 0.1441 & {$\pm\,0.0335$} \\
BiGRU GRU Fuser            & 0.1464 & {$\pm\,0.0389$} \\
BiLSTM coupled GRU Fuser                   & 0.1532 & {$\pm\,0.0381$} \\
BiGRU coupled gate                         & 0.1613 & {$\pm\,0.0277$} \\
GRU                                & 0.2914 & {$\pm\,0.0433$} \\
LSTM                               & 0.3926 & {$\pm\,0.0443$} \\
\bottomrule
\end{tabular}
}% <-- fecha o \resizebox
\end{column}
...
\vspace{1.5mm}
{\scriptsize
\(\star\) \textbf{Regra dos Dois Desvios Padrão:} 
Valores dentro de \(\mu \pm 2\sigma\) correspondem aproximadamente ao intervalo de confiança de 95\%.\\
\(\star\)\textbf{Teste de Wilcoxon:} Não foi possível realizar o teste estatístico de Wilcoxon entre os melhores modelos de predição e reconstrução,
