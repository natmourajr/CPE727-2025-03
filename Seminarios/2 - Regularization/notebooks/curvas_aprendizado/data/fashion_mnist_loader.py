"""
FashionMNIST Data Loading and Preprocessing

Reference: https://pytorch.org/vision/main/generated/torchvision.datasets.FashionMNIST.html
"""
...
class FashionMNISTDataModule:
    ...
    Args:
        data_dir (str): Directory to store/load FashionMNIST dataset
    ...
    def __init__(self, data_dir='./data', batch_size=64, val_split=0.1, num_workers=2, data_cap_rate=1):
        ...
        # FashionMNIST normalization values (computed on training set)
